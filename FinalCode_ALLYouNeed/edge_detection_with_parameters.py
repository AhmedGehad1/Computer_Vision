...
#Note to use this code u need to change to ur own Computer_Vision file
def save_image(img: np.ndarray):
    img_newname = "edge_detected.jpg"
    directory = r'C:\Users\ahmad\Desktop\Computer_Vision\images'
    path = os.path.join(directory, img_newname)
